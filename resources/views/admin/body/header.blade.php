            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="waves-effect waves-light rounded dropdown-toggle p-0" data-toggle="dropdown" title="User">
                        <img class="rounded-circle" src="{{ (!empty($profile->image) ? asset('upload/'.$profile->image) : url('upload/nouser.jpg')) }}" alt="User Avatar">
                    </a>
                    <ul class="dropdown-menu animated flipInX">
                        <li class="user-body">
                            <a class="dropdown-item" href="{{ route('profile.view') }}"><i class="ti-user text-muted mr-2"></i> Profile</a>
                            <a class="dropdown-item" href="{{ route('profile.edit_pw') }}"><i class="ti-pencil text-muted mr-2"></i> Change Password</a>
